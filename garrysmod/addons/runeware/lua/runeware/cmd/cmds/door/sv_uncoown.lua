...
local CMD       = {};
CMD.name        = "uncoown";
CMD.usage       = "uncoown <steamid/playername>";
CMD.description = "Unshare a property with another player.";
...
function CMD.run(pl,args,argstr)
	...
	if dist>10000 then
		cmd.help(CMD,pl,"You are too far away to unshare this property.");
		return;
	end
